  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-white/5 p-6 rounded-2xl shadow-xl border border-white/10">
        <h2 className="text-2xl font-bold text-white mb-4">Legal Consent</h2>
        ...
        <div className="flex items-start mb-6">
          ...
          <div className="ml-3 text-sm">
            <label htmlFor="consent" className="font-medium text-textMain">
        ...
        <button 
          ...
          disabled={!agreed}
          className={`w-full font-semibold py-3 rounded-lg transition-colors ${agreed ? 'bg-primary hover:bg-primary/90 text-white' : 'bg-white/10 text-white/40 cursor-not-allowed'}`}
        >
          Confirm & Start
        </button>
      </div>
